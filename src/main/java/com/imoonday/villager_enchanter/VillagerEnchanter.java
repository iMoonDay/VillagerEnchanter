...
import com.imoonday.villager_enchanter.mixin.ItemGroupsMixin;
...
public class VillagerEnchanter implements ModInitializer {
    ...
    public static final Item ENCHANT_REFRESH_BOOK = register(id("enchant_refresh_book"), new EnchantRefreshBookItem(new FabricItemSettings().maxCount(16)));

    @Override
    public void onInitialize() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroupsMixin.getTools()).register(entries -> entries.add(ENCHANT_REFRESH_BOOK));
